...
add_arg('save_matrix_path', str,   'pytorch/output/images/',         "保存混合矩阵的路径")
add_arg('resume_model',     str,   'pytorch/models/BaseModel_Emotion2Vec/best_model/',  "模型的路径")
# add_arg('resume_model',     str,   'pytorch/models/LSTM_Emotion2Vec/best_model/',  "模型的路径")
# add_arg('resume_model',     str,   'pytorch/models/BiLSTM_Emotion2Vec/best_model/',  "模型的路径")
